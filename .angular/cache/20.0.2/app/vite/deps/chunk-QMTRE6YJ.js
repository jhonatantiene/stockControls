...
import {
  BACKDROP_NO_SCROLL
} from "./chunk-C4MAT6QT.js";
import {
  MENU_BACK_BUTTON_PRIORITY,
  OVERLAY_BACK_BUTTON_PRIORITY,
  shouldUseCloseWatcher
} from "./chunk-3EKYB65I.js";
import {
  doc
} from "./chunk-GYOBXVLP.js";
import {
  config,
  configFromSession,
  configFromURL,
...
var AbstractControl = class {
  ...
  _cancelExistingSubscription() {
    ...
    if (this._asyncValidationSubscription) {
      ...
      const shouldHaveEmitted = (_c = ((_a6 = this._hasOwnPendingAsyncValidator) == null ? void 0 : _a6.emitEvent) || ((_b = this._hasOwnPendingAsyncValidator) == null ? void 0 : _b.shouldHaveEmitted)) != null ? _c : false;
      this._hasOwnPendingAsyncValidator = null;
...
var dismiss = (overlay, data, role, name, iosLeaveAnimation, mdLeaveAnimation, opts) => __async(null, null, function* () {
  ...
  try {
    ...
    (_a6 = overlay.willDismissShorthand) === null || _a6 === void 0 ? void 0 : _a6.emit({ data, role });
    const mode = getIonMode(overlay);
...
@ionic/core/components/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QMTRE6YJ.js.map
