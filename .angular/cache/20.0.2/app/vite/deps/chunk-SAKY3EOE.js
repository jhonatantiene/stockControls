...
var animateBackButton = function(a, t, r, n, o, e, i, s, l) {
  ...
  var O = r ? S : _;
  var j = [{ offset: 0, opacity: 0, transform: "scale(0.6)" }, { offset: 0.6, opacity: 0, transform: "scale(0.6)" }, { offset: 1, opacity: 1, transform: "scale(1)" }];
  ...
  N.beforeStyles({ "transform-origin": "".concat(p, " top") }).keyframes(O);
...
@ionic/core/dist/esm-es5/ios.transition-4047cb68.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SAKY3EOE.js.map
